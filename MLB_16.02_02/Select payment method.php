...
<body>
    ...
    <p class="select_paing_method"><b>Select paying method</b></p>
    ...
    <section>
        ...
        <a href="payment gateway.php"><img class="payment_method_image0" src="http://localhost/website/Images/VISA%20MASTER%20NEW.png" alt="" /></a>
        <a href="payment gateway.php">  <img class="payment_method_image3" src="http://localhost/website/Images/AMEX.jpg" alt="" /></a>
